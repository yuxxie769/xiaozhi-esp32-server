...
MAIN_HINT_BY_SLOT: dict[str, str] = {
    "morning": (
        "Do Morning call. Determine the status as awake/asleep/unknown/nobody ONLY based on "
        "the wake_up_check_result in CONTEXT_VARS. Result missing=>uncertain. Wake the user "
        "up if he is asleep. Use evidence only if provided; never fabricate. May use "
